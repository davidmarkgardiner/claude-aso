    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-2 text-gray-600">
          Welcome to your Namespace-as-a-Service platform. Monitor activity,
          manage resources, and provision new services.
        </p>
      </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {dashboardStats.totalNamespaces}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {dashboardStats.avgProvisionTime}
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Team: {request.team} • {request.createdAt}
                    </p>
                  </div>
                </div>
