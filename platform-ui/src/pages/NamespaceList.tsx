...
const NamespaceList: React.FC = () => {
  ...
  const filteredNamespaces = mockNamespaces.filter((ns) => {
    ...
    const matchesEnvironment =
      !environmentFilter || ns.environment === environmentFilter;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-sm text-gray-600">
        Showing {filteredNamespaces.length} of {mockNamespaces.length}{" "}
        namespaces
      </div>
          ...
          >
            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getResourceTierColor(namespace.resourceTier)}`}
                >
            ...
            {namespace.status === "active" && (
              <div className="space-y-2 mb-4">
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-xs font-medium ${getUtilizationColor(namespace.quota.cpu.percentage)}`}
                  >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-xs font-medium ${getUtilizationColor(namespace.quota.memory.percentage)}`}
                  >
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-screen overflow-y-auto">
            <div className="p-6">
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {selectedNamespace.team} team •{" "}
                    {selectedNamespace.environment}
                  </p>
                </div>
                <button
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span
                        className={getStatusBadge(selectedNamespace.status)}
                      >
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>
                        {new Date(selectedNamespace.createdAt).toLocaleString()}
                      </span>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="flex justify-between text-sm mb-1">
                          <span>CPU</span>
                          <span>
                            {selectedNamespace.quota.cpu.used}/
                            {selectedNamespace.quota.cpu.limit}
                          </span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            ...
                            style={{
                              width: `${selectedNamespace.quota.cpu.percentage}%`,
                            }}
                          />
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="flex justify-between text-sm mb-1">
                          <span>Memory</span>
                          <span>
                            {selectedNamespace.quota.memory.used}/
                            {selectedNamespace.quota.memory.limit}
                          </span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            className="h-2 bg-primary-500 rounded-full"
                            style={{
                              width: `${selectedNamespace.quota.memory.percentage}%`,
                            }}
                          />
                        </div>
                      </div>
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button className="btn-primary">View in Kubernetes</button>
              </div>
            </div>
          </div>
        </div>
