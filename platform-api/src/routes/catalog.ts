...
const serviceTemplates = [
  ...
  },
  {
    ...
    description: 'RESTful API microservice with service mesh, monitoring, and database access',
    category: 'Microservices',
    resourceTier: 'medium',
    features: ['istio-injection', 'monitoring-enhanced', 'database-access', 'external-ingress'],
  ...
  },
  {
    ...
    description: 'Machine learning development environment with GPU access and data tools',
    ...
    parameters: [
      ...
      },
      {
        ...
        options: ['tensorflow', 'pytorch', 'scikit-learn', 'xgboost', 'huggingface']
      }
    ]
  },
  {
...
router.post('/templates/:templateId/deploy',
  requireRole(['namespace:admin', 'namespace:developer']),
  asyncHandler(async (req, res) => {
    const { templateId } = req.params;
    ...
    const namespaceRequest = {
      namespaceName: templateParameters.appName || templateParameters.serviceName || 
    ...
    const { getProvisioningService } = await import('../services/namespaceProvisioning');
