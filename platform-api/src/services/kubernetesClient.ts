...
export class KubernetesClient {
  ...
  async createResourceQuota(
    namespace: string,
    quotaSpec: k8s.V1ResourceQuotaSpec,
  ): Promise<k8s.V1ResourceQuota> {
    try {
      ...
      const response = await this.coreApi.createNamespacedResourceQuota(
        namespace,
        resourceQuota,
      );
      ...
      logger.error(
        `Failed to create ResourceQuota for namespace ${namespace}:`,
        error,
      );
      throw error;
    }
  ...
  async createLimitRange(
    ...
    try {
      ...
      const response = await this.coreApi.createNamespacedLimitRange(
        namespace,
        limitRange,
      );
      ...
      logger.error(
        `Failed to create LimitRange for namespace ${namespace}:`,
        error,
      );
      throw error;
    }
  ...
  async createRoleBinding(
    ...
    try {
      ...
      const response = await this.rbacApi.createNamespacedRoleBinding(
        namespace,
        roleBinding,
      );
      ...
      logger.error(
        `Failed to create RoleBinding ${name} in namespace ${namespace}:`,
        error,
      );
      throw error;
    }
  ...
  async createNetworkPolicy(
    ...
    try {
      ...
      const response = await this.networkingApi.createNamespacedNetworkPolicy(
        namespace,
        networkPolicy,
      );
      ...
      logger.error(
        `Failed to create NetworkPolicy ${name} in namespace ${namespace}:`,
        error,
      );
      throw error;
    }
  ...
  async getNamespaceResourceUsage(namespace: string): Promise<{
    ...
    try {
      ...
      logger.error(
        `Failed to get resource usage for namespace ${namespace}:`,
        error,
      );
      throw error;
    }
  ...
  async deleteCustomResourcesByLabel(
    ...
    try {
      const resources = await this.listCustomResources(
        apiVersion,
        kind,
        namespace,
        labelSelector,
