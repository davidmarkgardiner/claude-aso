...
export const mockTemplates: CatalogTemplate[] = [
    ...
    parameters: [
      {
        ...
        validation: { pattern: '^[a-z][a-z0-9-]*[a-z0-9]$', minLength: 3, maxLength: 50 }
      },
      {
        name: 'databaseType',
        type: 'select',
  ...
  },
  {
    ...
    description: 'Scalable background job processing service with queue management',
    category: 'worker',
    version: '1.5.0',
        ...
        templates: [
          {
            ...
            steps: [
              ...
              [{ name: 'configure-autoscaling', template: 'configure-autoscaling' }],
  ...
  },
  {
    ...
    description: 'High-availability database cluster with backup and monitoring',
    category: 'database',
    version: '3.0.0',
        ...
        templates: [
          {
            ...
            steps: [
              ...
              [{ name: 'configure-monitoring', template: 'configure-monitoring' }],
